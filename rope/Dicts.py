...
'VirtualCameraDisplay':     'text',
'VirtualCameraInfoText':    'VIRTUAL CAMERA:\nFeed the swapped video output to a virtual camera for use in Zoom, Meet, Twitch, OBS etc.',
'VirtualCameraState':       False,
'VirtualCameraText':        'Virtual Camera',
...
'PreviewModeTextSelMode':           'Camera Stream',
'PreviewModeTextSelModes':          ['Camera Stream'],
